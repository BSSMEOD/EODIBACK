...
public class ItemUpdateForm {
    ...
    @Size(max = 100, message = "물품 이름은 1~100자 사이로 입력해주세요.")
    @Schema(description = "물품 이름", example = "아이패드", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String name;
    ...
    @Schema(description = "습득 일자(yyyy-MM-dd)", example = "2025-01-12", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String foundAt;

    @Schema(description = "습득 장소 ID", example = "3", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private Long placeId;

    @Size(max = 255, message = "장소 설명은 최대 255자까지 입력 가능합니다.")
    @Schema(description = "구체적인 장소 설명", example = "본관 2층 로비", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
