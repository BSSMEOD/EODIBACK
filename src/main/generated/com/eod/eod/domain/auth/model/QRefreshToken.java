...
public class QRefreshToken extends EntityPathBase<RefreshToken> {
    ...
    private static final long serialVersionUID = -2052315276L;
    ...
    public final com.eod.eod.domain.user.model.QUser user;
    ...
    public QRefreshToken(Class<? extends RefreshToken> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new com.eod.eod.domain.user.model.QUser(forProperty("user")) : null;
    }
